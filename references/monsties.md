...
| Azure Rathalos | Fire | P | 6 | Ca |
| Dreadking Rathalos | Fire | P | 7 | Ca |
| Rathian | Fire | S | 4 | Az |
| Pink Rathian | Fire | S | 5 | Az |
| Dreadqueen Rathian | Fire | S | 7 | Az |
| Nargacuga | Non-Elem | S | 5 | Ca |
| Green Nargacuga | Non-Elem | S | 5 | Ca |
| Silverwind Nargacuga | Non-Elem | S | 7 | Ca |
| Tigrex | Non-Elem | P | 5 | Ta |
| Brute Tigrex | Non-Elem | P | 6 | Ta |
| Grimclaw Tigrex | Non-Elem | P | 7 | Ta |
| Astalos | Thunder | T | 5 | Az |
| Boltreaver Astalos | Thunder | T | 7 | Az |
| Legiana | Ice | S | 4 | Ca |
| Paolumu | Non-Elem | T | 3 | Az |
| Barioth | Ice | S | 5 | Se |
| Sand Barioth | Non-Elem | S | 6 | Se |
| Seregios | Non-Elem | S | 5 | Ta |
| Monoblos | Non-Elem | P | 4 | Ta |
...
| Kecha Wacha | Non-Elem | T | 3 | Ca |
| Blangonga | Ice | P | 4 | Ca |
| Bishaten | Non-Elem | T | 3 | Az |

### Bird Wyverns (9)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Yian Kut-Ku | Fire | S | 2 | Az |
| Yian Garuga | Fire | S | 5 | Ca |
| Deadeye Yian Garuga | Fire | S | 7 | Ca |
| Pukei-Pukei | Non-Elem | T | 2 | Az |
| Gypceros | Non-Elem | T | 3 | Az |
| Purple Gypceros | Non-Elem | P | 5 | Az |
| Velocidrome | Non-Elem | S | 1 | Az |
| Malfestio | Non-Elem | T | 4 | Ca |
| Qurupeco | Fire | T | 2 | Az |

### Temnoceran (2)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Nerscylla | Non-Elem | T | 4 | Ca |
| Rakna-Kadaki | Fire | T | 5 | Se |

### Amphibians (2)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Zamtrios | Ice | T | 4 | Ca |
| Tetsucabra | Non-Elem | P | 3 | Az |

### Piscine Wyverns (2)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Plesioth | Water | T | 4 | Az |
| Lavasioth | Fire | P | 5 | Ta |

### Snake Wyverns (1)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Najarala | Non-Elem | T | 4 | Ca |

### Elder Dragons (8)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Nergigante | Dragon | P | 7 | PG |
| Ruiner Nergigante | Dragon | P | 7 | PG |
| Velkhana | Ice | T | 7 | PG |
| Teostra | Fire | P | 7 | PG |
| Kushala Daora | Ice | S | 7 | PG |
| Namielle | Water | T | 7 | PG |
| Kirin | Thunder | S | 7 | PG |
| Yama Tsukami | Dragon | T | 7 | PG |

### Carapaceons (2)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Daimyo Hermitaur | Water | P | 3 | Az |
| Shogun Ceanataur | Water | S | 4 | Ca |

### Herbivores (1)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Aptonoth | Non-Elem | P | 1 | Az |

### Wyvern (Other) (2)
| Name | Element | Type | Rank | Region |
|---|---|---|---|---|
| Malzeno | Dragon | T | 6 | Se |
| Gore Magala | Dragon | P | 5 | Ca |
...
### Elder Dragon Unlock Flow
1. Complete main story and defeat final boss
2. Unlocks High Rank expeditions
3. Elder Dragons spawn at **night only** in random regions
4. Use **SR Expedition Tickets** (100 Bottle Caps each from Bottle Cap Trader) for guaranteed high-rank dens
5. Elder Dragon eggs have **star pattern** — look for them in SR dens at night

### Elder Dragon Unique Abilities
| Elder Dragon | Signature Ability |
|---|---|
| Nergigante | Self-healing spikes — regenerates HP as it deals damage |
| Ruiner Nergigante | Enhanced self-healing + strongest raw physical damage |
| Velkhana | **Skill Seal** — disables opponent skills (PvP dominant) |
| Teostra | Explosive fire burst — Emperor of Flame, devastating Power/Fire |
| Kushala Daora | Wind disruption — fast, hard to pin, battlefield control |
| Namielle | Water/lightning hybrid AoE — unique dual-element Technical |

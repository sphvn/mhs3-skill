...
- Fills through combat (especially winning H2Hs)
- Full gauge → **Ride your monstie** → access **Kinship Skills**
- Kinship Skills: unique per monstie, devastating multi-hit or special-effect attacks
...
- Central mechanics introduced in MHS3
- Builds alongside Kinship through combat actions
- Synchro Rush: powerful coordinated combo between Rider and monstie
...
### Great Sword (Slash)
- **Mechanic**: Charge Gauge — hold attacks for higher damage
...
### Long Sword (Slash)
- **Mechanic**: Spirit Gauge + Stance Attacks — build spirit, spend on powerful moves
...
### Hammer (Blunt)
- **Mechanic**: Raw power + Stun — hit heads to build stun, topple monsters
- **Strengths**: Highest raw damage, excellent part breaking, simple to use
- **Pairs with**: Power monsties for maximum impact
- **Phase**: Strong all game

### Hunting Horn (Blunt)
- **Mechanic**: Melody system (RGB notes) — play sequences to buff party
- **Strengths**: Party support (ATK up, DEF up, healing, status cleanse), blunt damage
- **Pairs with**: Support/survivability builds, long fights
- **Phase**: Shines in endgame team scenarios

### Bow (Pierce)
- **Mechanic**: Charge Gauge + Coatings — apply Poison, Paralysis, Sleep
...
### Gunlance (Pierce)
- **Mechanic**: Guard + Shells — strong defense, explosive fixed damage
